...
<head>
  ...
  <style>
    ...
    @keyframes rotate {
      ...
      50% {
        transform: translateY(-10px) scale(1.2); /* Ajusta la distancia hacia arriba y el factor de escala */
      }
    }
...
<body>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 0 -->
        <div class="carousel-item active" style="background-image: url({{ asset('assets_public')}}/img/slide/logo_magic2.webp)">
          <div class="container" >
            <h2>Welcome to <span>Latín Community Magic Warriors</span></h2>
            <p>Clash Of Clans community where leaders and potential members are sought to grow this small but beautiful alliance.</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
          </div>
        </div>

        <!-- Slide 1 -->
        <div class="carousel-item" style="background-image: url({{ asset('assets_public')}}/img/slide/slide-1.webp)">
          <div class="container" >
            <h2>Welcome to <span>Latín Community Magic Warriors</span></h2>
            <p>Clash Of Clans community where leaders and potential members are sought to grow this small but beautiful alliance.</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url({{ asset('assets_public')}}/img/slide/slide-2.webp)">
          <div class="container" >
            <h2>Welcome to <span>Latín Community Magic Warriors</span></h2>
            <p>Clash Of Clans community where leaders and potential members are sought to grow this small but beautiful alliance.</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url({{ asset('assets_public')}}/img/slide/slide-3.webp)">
          <div class="container" >
            <h2>Welcome to <span>Latín Community Magic Warriors</span></h2>
            <p>Clash Of Clans community where leaders and potential members are sought to grow this small but beautiful alliance.</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
  ...
  <main id="main">
    ...
    <div class="alert-container" id="alertContainer">
      <div id="copyAlert" class="alert alert-info alert-dismissible fade" role="alert">
        <i class="bi bi-cloud-upload rotate-icon"></i><strong> Good!</strong> Getting information...
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About Us</h2>
          <p>
            Clash Of Clans community where leaders and potential members are sought to grow this small but beautiful alliance.
            We have several clans allied to this family...and we continue to grow
          </p>
        </div>

        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <img src="{{ asset('assets_public')}}/img/logo_magic.webp" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Clans allied to this family.</h3>
            <p class="fst-italic">
              These are some of our allied clans.
            </p>
            <ul>
              
              {{-- @foreach ($clans as $clanTag => $clan) --}}
              @foreach ($clans as $clan)
              <li>
                <i class="bi bi-bookmark-star-fill"></i> 
                {{-- <i class="bi col-md-2 col-sm-12"> --}}
                  {{-- <img src="{{ $clan['badge']}}" alt="Escudo Clan"> --}}
                  
                </i>
                <span class="">
                  {{-- {{ $clan['name']}} - {{ $clan['tag']}} members {{ $clan['members']}}/50. --}}
                  <b>{{ $clan->name}}</b> - {{ $clan->tag}} <i class="bi bi-box-arrow-right"></i>
                </span>
                 
              </li>
              
              {{-- <li><i class="bi bi-check-circle"></i> {{ $clan['name']}} members 49/50.</li> --}}
              @endforeach
              
              {{-- <li><i class="bi bi-check-circle"></i> Colombia members 50/50.</li>
              <li><i class="bi bi-check-circle"></i> Otro Clan mas members 30/50.</li> --}}
            </ul>
            <p>
    ...
    {{-- <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="image col-lg-6 order-1 order-lg-2" style='background-image: url("{{ asset('assets_public')}}/img/features.jpg");' data-aos="zoom-in"></div>
        </div>
          ...
          <div class="col-lg-8">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                ...
                <img src="{{ asset('assets_public')}}/img/departments-1.jpg" alt="" class="img-fluid">
                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus nostrum rem vero</p>
              </div>
              <div class="tab-pane" id="tab-2">
                <h3>Neurology</h3>
                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p>
                <img src="{{ asset('assets_public')}}/img/departments-2.jpg" alt="" class="img-fluid">
                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus nostrum rem vero</p>
              </div>
              <div class="tab-pane" id="tab-3">
                <h3>Hepatology</h3>
                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p>
                <img src="{{ asset('assets_public')}}/img/departments-3.jpg" alt="" class="img-fluid">
                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus nostrum rem vero</p>
              </div>
              <div class="tab-pane" id="tab-4">
                <h3>Pediatrics</h3>
                <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p>
                <img src="{{ asset('assets_public')}}/img/departments-4.jpg" alt="" class="img-fluid">
                <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus nostrum rem vero</p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 ">
            <div class="box featured " data-aos="fade-up" data-aos-delay="100">
              ...
              <ul>
                <li>Consult information on the current war</li>
              ...
              <div class="btn-wrap">
                <form action="{{ route('clans.warPublic') }}" method="POST" autocomplete="off">
                  @csrf
                  {{-- <input type="text" name="war_loc" id="war_loc" hidden> --}}
                  <div class="mb-3">
                    <!-- <label for="tag_clan_war" class="form-label">Ingrese el tag del Clan Ej.: #RUG0LC2Q </label> -->
                    <label for="tag_clan_war" class="form-label">Select a clan: </label>
                    <!-- <input type="text" class="form-control" id="tag_clan_war" name="tag_clan_war" required> -->
                    <select class="form-select" name="tag_clan_war" id="tag_clan_war" required>
                      {{-- @foreach ($clans as $clanTag => $clan) --}}
                      @foreach ($clans as  $clan)
                  ...
                  <button type="submit" class="btn-buy" style="border: none" onclick="showDialog()">
                    Come on
                  </button>
                </form>
                {{-- <a href="#" class="btn-buy">Come on</a> --}}
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box featured" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li>Consult information from the CWL</li>
              </ul>
              <div class="btn-wrap">
                <form action="{{ route('clans.cwlPublic') }}" method="POST" autocomplete="off">
                  @csrf
                  {{-- <input type="text" name="war_loc" id="war_loc" hidden> --}}
                  <div class="mb-3">
                    <!-- <label for="tag_clan_war" class="form-label">Ingrese el tag del Clan Ej.: #RUG0LC2Q </label> -->
                    <label for="tag_clan_cwl" class="form-label">Select a clan: </label>
                    <!-- <input type="text" class="form-control" id="tag_clan_war" name="tag_clan_war" required> -->
                    <select class="form-select" name="tag_clan_cwl" id="tag_clan_cwl" required>
                      @foreach ($clans as $clanTag => $clan)
                      <option value="{{ $clan['id']}}">{{ $clan['name']}}</option>
                      @endforeach
                      <!-- <option value="9Q9YY0R9">Familia Andrade</option> -->
                      <!-- <option value="2G92J8VRU">The One Piece</option> -->
                    </select>
                    <label for="dayCWL" class="form-label">Select a war day: </label>
                    <!-- <input type="text" class="form-control" id="tag_clan_war" name="tag_clan_war" required> -->
                    <select class="form-select" name="dayCWL" id="dayCWL" required>
          ...
          <div class="col-lg-4 col-md-12 mt-4 mt-lg-0">
            <div class="box featured" data-aos="fade-up" data-aos-delay="300">
              <h3>Clan Capital</h3>
              <ul>
                <li>Consult information about the Clan Capital</li>
              </ul>
              <div class="btn-wrap">
                <form action="{{ route('clans.capitalPublic') }}" method="POST" autocomplete="off">
                  @csrf
                  {{-- <input type="text" name="war_loc" id="war_loc" hidden> --}}
                  <div class="mb-3">
                    <!-- <label for="tag_clan_war" class="form-label">Ingrese el tag del Clan Ej.: #RUG0LC2Q </label> -->
                    <label for="tag_clan_capital" class="form-label">Select a clan: </label>
                    <!-- <input type="text" class="form-control" id="tag_clan_war" name="tag_clan_war" required> -->
                    <select class="form-select" name="tag_clan_capital" id="tag_clan_capital" required>
                      @foreach ($clans as $clanTag => $clan)
                      <option value="{{ $clan['id']}}">{{ $clan['name']}}</option>
                      @endforeach
                      <!-- <option value="9Q9YY0R9">Familia Andrade</option> -->
  ...
  <script>
    function showDialog(){
      // console.log('presionandooooo...');
      // Mostrar el alerta
      document.getElementById('copyAlert').classList.add('show');
        // document.getElementById('alertContainer').classList.add('zz-index');
        document.getElementById('alertContainer').style.zIndex = '9999';
        document.getElementById('alertContainer').style.display = 'block';
        // Ocultar el alerta después de 2 segundos
        setTimeout(function() {
          document.getElementById('copyAlert').classList.remove('show');
          // document.getElementById('alertContainer').classList.remove('zz-index');
          document.getElementById('alertContainer').style.zIndex = '0';
