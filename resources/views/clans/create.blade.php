...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('clans.store') }}" autocomplete="off" class="form-horizontal">
            @csrf

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Nuevo Clan') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('tag') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('tag') ? ' is-invalid' : '' }}" name="tag" id="input-tag" type="text" placeholder="{{ __('Tag del Clan') }}" value="{{ old('tag') }}" required="true" aria-required="true"/>
                      @if ($errors->has('tag'))
